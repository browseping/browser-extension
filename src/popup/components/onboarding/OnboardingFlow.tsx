...
import { FiMonitor, FiShield, FiUsers, FiZap, FiCheck } from 'react-icons/fi';
...
const OnboardingFlow: React.FC<OnboardingFlowProps> = ({ onComplete }) => {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "You decide what to share and with whom. Granular privacy settings give you full control over your digital presence.",
      features: [
        "Customize what you share",
        "Choose who sees your tabs",
        "Go private anytime you want"
      ]
    },
    {
